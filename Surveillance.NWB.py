...
# __________________Adding frame for video output______________
...
frame = LabelFrame(window, width=1300, height=50,
                   fg="black", bg="aqua").place(x=0, y=700)
foot = Label(frame, text="Developed using Python 3.8", font=(
    "Times New Roman", 11), fg="black", bg="aqua").place(x=840, y=715)
window.mainloop()
